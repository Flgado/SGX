...
static sgx_status_t SGX_CDECL sgx_ecall_show_secret_key(void* pms)
{
	sgx_status_t status = SGX_SUCCESS;
	if (pms != NULL) return SGX_ERROR_INVALID_PARAMETER;
	ecall_show_secret_key();
	return status;
}
...
SGX_EXTERNC const struct {
	...
	14,
	{
		...
		{(void*)(uintptr_t)sgx_ecall_show_secret_key, 0, 0},
