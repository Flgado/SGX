...
sgx_status_t generate_ecc_key_pair(PublicKey* enclave_public_key, size_t key_size);
sgx_status_t teste(const unsigned char* msg, Signature* enclave_signature, size_t msg_size);
